...
class OrderController extends Controller
{
    ...
    //     // Add these near the top of your placeOrder method
    //     $discountAmount = 0;
    //     $giftCardAmount = 0;
    ...
    //     // Calculate gift card if applied
    //     if ($request->has('gift_card_code')) {
    //         $giftCard = GiftCard::where('code', $request->gift_card_code)->first();
    //         if ($giftCard && $giftCard->balance > 0) {
    //             $giftCardAmount = min($giftCard->balance, $subtotal);
    //         }
    //     }

    //     // Then update your order total calculation:
    //     $order->order_item_total = $subtotal;
    //     $order->discount = $discountAmount;
    //     $order->gift = $giftCardAmount;
    //     $order->order_total = $subtotal + $request->shipping_amount - $discountAmount - $giftCardAmount;
    ...
    //                 $order_products->t_variation_price = $t_variation_price;
    ...
    public function placeOrder(Request $request)
    {
        ...
        $shippingAmount = $request->shipping_amount ?? ($cart['shipping'] ?? 0);

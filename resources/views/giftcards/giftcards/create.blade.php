...
<div class="content-header row">
        ...
        <div class="row breadcrumbs-top d-inline-block">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Create New Giftcard</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="content-header-right col-md-4 col-12">
        <div class="btn-group float-md-right">
            <a class="btn btn-info mb-1" href="{{url('/giftcards/giftcards')}}">View Giftcard</a>
        </div>
    </div>
</div>
          ...
          <div class="col-md-7">
              <div class="card">
                  ...
                  <div class="card-content collapse show">
                      <div class="card-body">
                        {!! Form::open(['url' => '/giftcards/giftcards', 'files' => true]) !!}
                        @include ('giftcards.giftcards.form')
                        {!! Form::close() !!}
                       </div>
                  </div>
              </div>

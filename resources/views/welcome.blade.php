                        ...
                        <div class="swiper mySwiper-banner">
                            <div class="swiper-wrapper">
                                ...
                                @foreach($banner as $key => $val_banner)
                                    ...
                                    @else
                                        <div class="swiper-slide swipper-banner banner-{{ $key + 1 }}"
                                            style="background-image: url({{asset($val_banner->image)}}) !important;">
                                            <div class="sec1-text">
    ...
    {{-- <section class="section1">
        <div class="container-fluid p-0">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <iframe style="width: 100%;" height="500" src="https://www.youtube.com/embed/xnEteozzpUU"
                        title="Doctors without Boredom –Spoke &amp; Word Ep. 4– Perfect Tabes, Emergency Medicine, and Dr. Luis Pinzon"
                        frameborder="0"
                ...
                @foreach($get_product as $key => $val_product)
                    <div class="col-lg-4 col-md-4 col-6">
                        <div class="opt-sec-2-main">
                            <a
                                href="{{ URL('product_detail/' . $val_product->id . '/' . $val_product->category . '/' . $val_product->subcategory . '/' . $val_product->childsubcategory) }}">
            ...
            <div class="row">
                ...
                <div class="col p-0">
                    <div class="opt-sec5-main">
                        ...
                        <div class="opt-sec5-text">
                            <a href="{!! App\Http\Traits\HelperTrait::returnFlag(1960) !!}" style="text-decoration:none;"
                                target="_blank">
                ...
                <div class="col p-0">
                    <div class="opt-sec5-main">
                        ...
                        <div class="opt-sec5-text">
                            <a href="{!! App\Http\Traits\HelperTrait::returnFlag(1962) !!}" style="text-decoration:none;"
                                target="_blank">
                ...
                <div class="col p-0">
                    <div class="opt-sec5-main">
                        ...
                        <div class="opt-sec5-text">
                            <a href="{!! App\Http\Traits\HelperTrait::returnFlag(1973) !!}" style="text-decoration:none;"
                                target="_blank">

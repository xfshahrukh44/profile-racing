                    ...
                    <div class="col-12 col-lg-10 offset-lg-1">
                            ...
                            <div class="text-95 col-sm-4 offset-sm-4 align-self-start d-sm-flex justify-content-end">
                                ...
                                <div class="text-grey-m2">
                                    ...
                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                            class="text-600 text-90">ID:</span> #{{ $order->invoice_number }}</div>

                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                            class="text-600 text-90">Order Date:</span>
                                        {{ date('d F, Y', strtotime($order->created_at)) }}</div>

                                    <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                            class="text-600 text-90">Status:</span> <span
                                            class="badge badge-warning badge-pill px-25">{{ $order->order_status }}</span>
                                    </div>
                                    @if ($order->transaction_id != '')
                                        <div class="my-2"><i class="fa fa-circle text-blue-m2 text-xs mr-1"></i> <span
                                                class="text-600 text-90">Transaction ID:</span>
                        ...
                        <div class="mt-4">
                            <div class="row text-600 text-white bgc-default-tp1 py-25">
                                ...
                                <div class="d-none d-sm-block col-3">Product Name</div>
                            ...
                            <div class="text-95 text-secondary-d3">
                                ...
                                @foreach ($order_products as $order_product)
                                    <div class="row mb-2 mb-sm-0 py-25">
                                        ...
                                        <div class="d-none d-sm-block col-3">{{ $order_product->order_products_name }}
                                        </div>
                                        ...
                                        <div class="d-none d-sm-block col-2">${{ $order_product->order_products_price }}
                                        </div>
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-12 col-sm-5 text-grey text-90 order-first order-sm-last">
                                    ...
                                    <div class="row my-2">
                                        ...
                                        <div class="col-5">
                                            <span
                                                class="text-110 text-secondary-d1">${{ $order_product->t_variation_price }}</span>
                                        </div>
                                    </div>

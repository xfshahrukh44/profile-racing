    ...
    <div class="row">
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <input class="form-control dropify" name="image" type="file" id="image" {{ ($product->image != '') ? "data-default-file = /$product->image" : ''}} {{ ($product->image == '') ? "required" : ''}}
                    value="{{$product->image}}">
            </div>
        </div>
                    ...
                    @foreach($product_images as $product_image)
                        ...
                        <div class="image-single" style="padding: 15px;">
                            ...
                            <button type="button" class="btn btn-danger" data-repeater-delete=""
                                onclick="getInputValue({{$product_image->id}}, this);"> <i class="ft-x"></i>Delete</button>
                        </div>
                        <!--</div>-->
                    @endforeach
                    <!--</div>-->
                </div>
                <input class="form-control dropify" name="images[]" type="file" id="images" {{ ($product->additional_image != '') ? "data-default-file = /$product->additional_image" : ''}}
                        ...
                        <div data-repeater-list="attribute">
                            <div data-repeater-item="" class="row">
                                ...
                                <div class="form-group mb-1 col-sm-12 col-md-2">
                                    ...
                                    <br>
                                    <input type="number" name="v_price[]" class="form-control" step=".01" id="price"

                                ...
                                <div class="opt-sec-2-main">
                                    @if ($route_category != '' && $route_subcategory == '' && $route_child_subcategory == '')
                                        ...
                                        @elseif($route_category != '' && $route_subcategory != '' && $route_child_subcategory == '')
                                            <a
                                                href="{{ URL('product_detail/' . $val_product->id . '/' . $route_category . '/' . $route_subcategory) }}">
                                            @elseif($route_category != '' && $route_subcategory != '' && $route_child_subcategory != '')
                                                <a
                                                    href="{{ URL('product_detail/' . $val_product->id . '/' . $route_category . '/' . $route_subcategory . '/' . $route_child_subcategory) }}">
                                                @elseif($route_category == '' && $route_subcategory == '' && $route_child_subcategory == '')
                                                    <a
                                    ...
                                    <div class="opt-sec2-text">
                                        <p> {{ \Illuminate\Support\Str::limit($val_product->product_title, 50, $end = '...') }}
                                        </p>
                                        <h6>${{ $val_product->price_with_increment }} <?php if ($val_product->maximum_price != '' && $val_product->maximum_price != '0') {
                                            echo ' - $' . $val_product->maximum_price;
                                        } ?> </h6>

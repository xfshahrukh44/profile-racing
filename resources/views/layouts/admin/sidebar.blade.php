        ...
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item">
                ...
                <ul class="menu-content">
                    ...
                    <li
                        class="{{ (request()->is('childsubcategory/childsubcategory') || request()->is('childsubcategory/childsubcategory/*')) ? 'active' : '' }}">
                    ...
                    <li
                        class="{{ (request()->is('admin/bundleproduct') || request()->is('admin/bundleproduct/*')) ? 'active' : '' }}">
                        <a class="menu-item" href="{{url('admin/bundleproduct')}}"><i></i>
                            <span data-i18n="eCommerce">Bundle Products</span>
                        </a>
                    </li>
                    <li
                    ...
                    <li
                        class="{{ (request()->is('giftcards/giftcards') || request()->is('giftcards/giftcards/*')) ? 'active' : '' }}">
                        <a class="menu-item" href="{{url('giftcards/giftcards')}}"><i></i>
                            <span data-i18n="eCommerce">Giftcards</span>
                        </a>
                    </li>
                    <li
                        class="{{ (request()->is('discount/discount') || request()->is('discount/discount/*')) ? 'active' : '' }}">
            ...
            <li
                class="nav-item {{ (request()->is('instagram/instagram') || request()->is('instagram/instagram/*')) ? 'active' : '' }}">
